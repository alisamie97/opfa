...
class ControllerExtensionPaymentOCFSaman extends Controller {
	public function index() {
		...
		/*$data['RedirectURL'] = $this->url->link('extension/payment/ocf_saman/callback&order_id=' . $this->encryption->encrypt($this->config->get('config_encryption'), $order_id), true);*/
		$data['RedirectURL'] = $this->url->link('extension/payment/ocf_saman/callback&order_id=' . $order_id, true);
		$data['ResNum'] = $order_id;
